...
import fgoPreValidacao from './endpoints/fgo-pre-validacao.js'
import fgoRemessa from './endpoints/fgo-remessa.js'
...
import { iniciarWorkerFgoPreValidacao } from './workers/fgo-pre-validacao.worker.js'
...
app.route('/fgo/pre-validacao', fgoPreValidacao)
app.route('/fgo/remessa', fgoRemessa)
...
iniciarWorkerFgoPreValidacao().catch(err => console.error('[worker:fgo-pre-validacao] falha fatal:', err))
